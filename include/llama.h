...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_Q4_K_F        = 39, // except 1d tensors
    ...
    typedef struct llama_model_quantize_params {
        ...
        bool awq_protect;                     // enable AWQ-style channel protection (Q4_K_F only)
        float awq_ratio;                      // fraction of channels to protect (e.g. 0.01 = 1%)
        int32_t awq_min_channels;             // minimum number of channels to protect
